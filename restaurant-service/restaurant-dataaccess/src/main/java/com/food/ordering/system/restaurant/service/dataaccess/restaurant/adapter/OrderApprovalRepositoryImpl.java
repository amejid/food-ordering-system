...
public class OrderApprovalRepositoryImpl implements OrderApprovalRepository {
	...
	public OrderApproval save(OrderApproval orderApproval) {
		return this.restaurantDataAccessMapper.orderApprovalEntityToOrderApproval(this.orderApprovalJpaRepository
			.save(this.restaurantDataAccessMapper.orderApprovalToOrderApprovalEntity(orderApproval)));
	}
