...
public class PaymentOutboxScheduler implements OutboxScheduler {
	...
	public void processOutboxMessage() {
		...
		if (outboxMessagesResponse.isPresent() && !outboxMessagesResponse.get().isEmpty()) {
			...
			outboxMessages.forEach(outboxMessage -> this.paymentRequestMessagePublisher.publish(outboxMessage,
	...
	private void updateOutboxStatus(OrderPaymentOutboxMessage orderPaymentOutboxMessage, OutboxStatus outboxStatus) {
		...
		this.paymentOutboxHelper.save(orderPaymentOutboxMessage);
		log.info("OrderPaymentOutboxMessage with outbox id: {} updated to status: {}",
