...
public class CustomerCreateCommandHandler {
	...
	public CustomerCreateCommandHandler(CustomerDomainService customerDomainService,
			CustomerRepository customerRepository, CustomerDataMapper customerDataMapper) {
	...
	public CustomerCreatedEvent createCustomer(CreateCustomerCommand createCustomerCommand) {
		Customer customer = this.customerDataMapper.createCustomerCommandToCustomer(createCustomerCommand);
		CustomerCreatedEvent customerCreatedEvent = this.customerDomainService.validateAndInitiateCustomer(customer);
		Customer savedCustomer = this.customerRepository.createCustomer(customer);
