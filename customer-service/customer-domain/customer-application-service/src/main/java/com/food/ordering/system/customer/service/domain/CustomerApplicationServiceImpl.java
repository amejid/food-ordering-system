...
class CustomerApplicationServiceImpl implements CustomerApplicationService {
	...
	CustomerApplicationServiceImpl(CustomerCreateCommandHandler customerCreateCommandHandler,
	...
	public CreateCustomerResponse createCustomer(CreateCustomerCommand createCustomerCommand) {
		CustomerCreatedEvent customerCreatedEvent = this.customerCreateCommandHandler
			.createCustomer(createCustomerCommand);
		this.customerMessagePublisher.publish(customerCreatedEvent);
		return this.customerDataMapper.customerToCreateCustomerResponse(customerCreatedEvent.getCustomer(),
